 ...
 * @version $Revision: 783910 $ $Date: 2009-06-11 23:13:54 +0200 (Thu, 11 Jun
 * 2009) $
...
//    public static final String EMAIL_BODY = "email.body";
    ...
    public static final String POP_IMAP = "popimap";
    /**
    ...
    public static final String MAIL_EXCHANGE_SERVER = "mail.exchange.server";
    public static final String RECEIVER_USERNAME = "receiver.username";
    public static final String RECEIVER_PASSWORD = "receiver.password";
    public static final String MAIL_EXCHANGE_DOMAIN = "mail.exchange.domain";
...
//    public static final String US_ASCII = "us-ascii";
    ...
    /**
     * Instance of an <code>Authenticator</code> object that will be used when
     * authentication is requested from the mail server.
     */
    ...
    /**
     * The port number of the SSL enabled SMTP server; defaults to the standard
     * port, 465.
     */
    ...
    /**
     * Address to which undeliverable mail should be sent. Because this is
     * handled by JavaMail as a String property in the mail session, this
     * property is of type <code>String</code> rather than
    ...
    /**
     * Sets the <code>Authenticator</code> to be used when authentication is
     ...
     * @throws java.nio.charset.IllegalCharsetNameException if the charset name
     * is invalid
     * @throws java.nio.charset.UnsupportedCharsetException if no support for
     * the named charset exists in the current JVM
     * @since 1.0
     */
...
//            System.out.println("address:"+address);
     ...
     * by the charset of {@link #setCharset(java.lang.String) setCharset()}. If
     * it is not set, it will be encoded using the Java platform's default
     * charset (UTF-16) if it contains non-ASCII characters; otherwise, it is
     * used as is.
     *
    ...
    /**
     * Add a reply to address to the email. The email address will also be used
    ...
    /**
     * Returns the internal MimeMessage. Please not that the MimeMessage is
     * build by the buildMimeMessage() method.
     *
